...
namespace OnlineStoreTesting
{
    public class Testss
    {
        ...
        public void First_Scenario()
        {
            ...
            _customerLoginPage.LogIn("louisaharutyunyan.98@gmail.com", "test_password98");
        ...
        public void Third_Scenario()
        {
            ...
            _bagProductCategoryPage.AddToCart("Push It Messenger Bag");
            _bagProductCategoryPage.AddToCart("Overnight Duffle");
            _bagProductCategoryPage.NavigateToProductInfo("Driven Backpack");
